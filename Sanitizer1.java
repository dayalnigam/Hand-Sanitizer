...
*/  
public class Sanitizer1 extends AppCompatActivity {
    TextView a,b,c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanitizer1);
        a=(TextView)findViewById(R.id.mytext1);
        ...
        Ref = FirebaseDatabase.getInstance().getReference().child("Sanitizer1");
        Ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                final LineDataSet set1 = new LineDataSet(yData,"Sanitizer1"+" "+dateTime);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Sanitizer1.this, "Fail to load post", Toast.LENGTH_SHORT).show();
