...
*/  
public class Sanitizer3 extends AppCompatActivity {
    TextView a,b,c;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanitizer3); a=(TextView)findViewById(R.id.mytext1);
        ...
        Ref = FirebaseDatabase.getInstance().getReference().child("Sanitizer3");
        Ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                final LineDataSet set1 = new LineDataSet(yData,"Sanitizer3"+" "+dateTime);
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(Sanitizer3.this, "Fail to load post", Toast.LENGTH_SHORT).show();
